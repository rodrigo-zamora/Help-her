...
public class SoundHandler {
    ...
    public static void playRandomSound() {
        if (soundArrayList.size() == 0) {
            soundArrayList.add(new Sound("sounds/effects/backgroundEffects/1.mp3", Sound.EFFECT));
            soundArrayList.add(new Sound("sounds/effects/backgroundEffects/2.mp3", Sound.EFFECT));
            soundArrayList.add(new Sound("sounds/effects/backgroundEffects/3.mp3", Sound.EFFECT));
            soundArrayList.add(new Sound("sounds/effects/backgroundEffects/4.mp3", Sound.EFFECT));
            soundArrayList.add(new Sound("sounds/effects/backgroundEffects/5.mp3", Sound.EFFECT));
            soundArrayList.add(new Sound("sounds/effects/backgroundEffects/6.mp3", Sound.EFFECT));
            soundArrayList.add(new Sound("sounds/effects/backgroundEffects/7.mp3", Sound.EFFECT));
            soundArrayList.add(new Sound("sounds/effects/backgroundEffects/8.mp3", Sound.EFFECT));
            soundArrayList.add(new Sound("sounds/effects/backgroundEffects/9.mp3", Sound.EFFECT));
        }
